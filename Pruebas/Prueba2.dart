      ...
      if (key.controlChar != -1) {
        switch (key.controlChar) {
          ...
          case ControlCharacter.enter:
            ...
            handleMenuSelection(
                selectedIndex, temas, cantidades, estudiantes, asignaciones, random);
...
void handleMenuSelection(int index, List<String> temas, List<int> cantidades, List<String> estudiantes,
    List<List<String>> asignaciones, Random random) {
  final console = Console();
  switch (index) {
    case 0:
